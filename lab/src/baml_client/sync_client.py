...
class BamlSyncClient:
    ...
    def ExtractArticleMetadata(
        self,
        article: str,
        baml_options: BamlCallOptions = {},
    ) -> types.ArticleMetadata:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return cast(types.ArticleMetadata, raw.cast_to(types, types, partial_types, False))
    ...
    def ExtractEntities(
      ...
      return cast(List[types.Entity], raw.cast_to(types, types, partial_types, False))
    ...
    def QueryExpansion(
      ...
      return cast(types.Question, raw.cast_to(types, types, partial_types, False))
...
class BamlStreamClient:
    ...
    def ExtractArticleMetadata(
        ...
        article: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[partial_types.ArticleMetadata, types.ArticleMetadata]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlSyncStream[partial_types.ArticleMetadata, types.ArticleMetadata](
        raw,
        lambda x: cast(partial_types.ArticleMetadata, x.cast_to(types, types, partial_types, True)),
        lambda x: cast(types.ArticleMetadata, x.cast_to(types, types, partial_types, False)),
        self.__ctx_manager.get(),
      )
    ...
    def ExtractEntities(
        ...
        question: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[List[partial_types.Entity], List[types.Entity]]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlSyncStream[List[partial_types.Entity], List[types.Entity]](
        raw,
        lambda x: cast(List[partial_types.Entity], x.cast_to(types, types, partial_types, True)),
        lambda x: cast(List[types.Entity], x.cast_to(types, types, partial_types, False)),
        self.__ctx_manager.get(),
      )
    ...
    def QueryExpansion(
        ...
        question: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[partial_types.Question, types.Question]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlSyncStream[partial_types.Question, types.Question](
        raw,
        lambda x: cast(partial_types.Question, x.cast_to(types, types, partial_types, True)),
        lambda x: cast(types.Question, x.cast_to(types, types, partial_types, False)),
        self.__ctx_manager.get(),
      )
